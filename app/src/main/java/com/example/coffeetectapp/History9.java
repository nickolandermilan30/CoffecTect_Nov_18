...
public class History9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<SavedResult> savedResults = SavedResultsManager.getHistory9List();  // Ito ay maaaring pagbabago depende sa iyong implementation
        ...
        if (SavedResultsManager.getHistory9List().size() < 10) {  // Ito ay maaaring pagbabago depende sa iyong implementation
        ...
        recommendationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isRecommendationClickable) { // Check if button is clickable
                    Intent intent = new Intent(History9.this, rec9.class);
            ...
            public void onClick(View view) {
                ...
                builder.setPositiveButton("Clear", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        SavedResultsManager.clearHistory9Results();  // Ito ay maaaring pagbabago depende sa iyong implementation
